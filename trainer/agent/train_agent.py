...
if __name__ == "__main__":
    ...
    parser.add_argument("--sglang_model_path", type=str, default="../tokenizer", help="SGLang tokenizer路径")
    ...
    lm_config = MicaConfig(hidden_size=args.hidden_size, num_hidden_layers=args.num_hidden_layers,
