...
- 复现：先运行 `python3 scripts/check_repository.py` 和 Python compile 检查，再按目标实验目录的 `command.sh`、`config.json`、`run.json` 执行；环境与产物边界见 [仓库管理方式](../../docs/repository-management.md)。
